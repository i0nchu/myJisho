"""Dependency-free localhost HTTP server for the Kotoba editor."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the Kotoba local content editor")
    ...
    print(f"Kotoba editor: http://{args.host}:{server.server_port}")
