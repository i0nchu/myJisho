...
| AC-08 Desktop/mobile | 12-case AC-08/09 suite plus 8 platform UX cases cover 390×844, 1200×800, keyboard selection, Space guard, shortcut disable and platform-adaptive navigation; browser smoke confirms latest build | Full keyboard/IME matrix on iOS, Windows and macOS | PASS automated / EXTERNAL DEVICE |
