"""Generate the versioned myJisho search-acceptance corpus.
...
KATAKANA_CASES = (
    ...
    ("コンピューター", "ｺﾝﾋﾟｭｰﾀｰ"), ("スマートフォン", "マート"),
    ("インターネット", "インター"), ("ホテル", "ホテル"),
...
def fixture_payload() -> dict[str, Any]:
    ...
    return {
        "schema_version": 1,
        "corpus_id": "myjisho-search-acceptance-v1",
