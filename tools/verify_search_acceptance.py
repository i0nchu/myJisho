"""Validate and execute the fixed myJisho search-acceptance corpus."""
...
def corpus_to_canonical(corpus: dict[str, Any]) -> dict[str, Any]:
    ...
    validate_corpus(corpus)
    source_id = "myjisho_search_acceptance_cc0"
    ...
    document = {
        ...
        "sources": [
            {
                "source_id": source_id,
                "title": "myJisho fixed search acceptance corpus",
                "source_type": "original",
                "author": "myJisho project QA (AI-assisted draft)",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.database is not None:
        ...
        with tempfile.TemporaryDirectory(prefix="myjisho-search-acceptance-") as root:
