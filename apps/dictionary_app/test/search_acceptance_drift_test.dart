...
import 'package:myjisho_dictionary_app/features/dictionary/domain/japanese_query_normalizer.dart';
...
void main() {
  ...
  setUpAll(() async {
    ...
    temporaryDirectory = await Directory.systemTemp.createTemp(
      'myjisho-search-acceptance-drift-',
    );
...
''');
    for (final value in corpus['lexicon']! as List<Object?>) {
      ...
      final payload = <String, Object?>{
        ...
        'source_ids': ['myjisho_search_acceptance_cc0'],
